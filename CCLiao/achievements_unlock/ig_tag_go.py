...
ss = requests.session()
# ss.cookies['mid'] = 'Xbpi3gALAAEDTPUX3xy50ylIz6tr'
# ss.cookies['csrftoken'] = '3P5TehYTwYdO7l9XWMwazOMZhumQHSRT'
...
def tag_main(tag):
    ...
    # print(html)
    urls = get_urls(html)
    dirpath = r'.\ig_download\{}'.format(tag)
    ...
    for i in range(len(urls)):
        ...
        try:
            ...
            file_path = r'.\ig_download\{0}\{1}.{2}'.format(tag, md5(content).hexdigest(), endw)
