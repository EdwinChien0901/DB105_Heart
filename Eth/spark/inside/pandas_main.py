...
def pandascon(key):   
    with open('/home/cloudera/Documents/test/tagsv3.txt', encoding='utf-8') as file:
        tags = file.read()
    tags = tags.replace('\ufeff', '')
    tags = tags.replace('\n', '')
    tags = tags.split(' ')
    ...
    csv = pd.read_csv('/home/cloudera/Documents/test/tag_spot_all.csv')
    ...
    places_selected = pd.read_csv('/home/cloudera/Documents/test/places_selected.csv')
    o=0
